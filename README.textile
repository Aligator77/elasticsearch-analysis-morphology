...
| 5.0.0-alpha5                           | 5.0.0-alpha5  | http://dl.bintray
.com/content/imotov/elasticsearch-plugins/org/elasticsearch/elasticsearch-analysis-morphology/5.0.0-alpha5/elasticsearch-analysis-morphology-5.0.0-alpha5.zip |
...
where @URL@ is the URL of the plugin from the compatibility table. For examples to install version @2.3.5@ run

<pre>
bin/plugin install http://dl.bintray.com/content/imotov/elasticsearch-plugins/org/elasticsearch/elasticsearch-analysis-morphology/2.3.5/elasticsearch-analysis-morphology-2.3.5.zip
</pre>
